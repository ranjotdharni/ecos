import { getAllCongregationOwnersBusinessesEarningData } from "@/customs/utils/math/earnings"
...
export async function GET(request: NextRequest) {
    ...
    const earnings: BusinessEarningComponents[] | GenericError = await getAllCongregationOwnersBusinessesEarningData(cookieList.get('username')!.value)
